...
def item_page():
    ...
    Button(item_screen, text="INSERT",width=20, height=3,bd=10).pack()
    Button(item_screen, text="UPDATE",width=20, height=3,bd=10).pack()
    Button(item_screen, text="DISPLAY",width=20, height=3,bd=10).pack()
    Button(item_screen, text="DELETE",width=20, height=3,bd=10).pack()
    Button(item_screen, text="DISPLAY ALL",width=20, height=3,bd=10).pack()
...
def customer_page():
    ...
    Button(cus_screen, text="INSERT",width=20, height=3,bd=10).pack()
    Button(cus_screen, text="UPDATE",width=20, height=3,bd=10).pack()
    Button(cus_screen, text="DISPLAY",width=20, height=3,bd=10).pack()
    Button(cus_screen, text="DELETE",width=20, height=3,bd=10).pack()
    Button(cus_screen, text="DISPLAY ALL",width=20, height=3,bd=10).pack()
